# ID Gateway Karate Test Suite

This is a standalone Karate test suite for black-box testing of the ID Gateway OAuth2 API.

## Prerequisites

- Java 11 or higher
- Maven 3.6 or higher
- ID Gateway API running (default: http://localhost:8080)
...
- `BASE_URL` - The base URL of the ID Gateway API (default: `http://localhost:8080`)
...
- Ensure the ID Gateway API is running
...
Same as the parent ID Gateway project.
